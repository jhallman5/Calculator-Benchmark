...
- [stretch] Each mathematical operation is done on the server
- [stretch] Each mathematical operation should have it's own API endpoint
- [stretch] Each request for a mathematical operation is a `post` request
- [stretch] Each operation request responds with `JSON`
- [stretch] When the calculator is waiting for an operation request response, it ignores all input
